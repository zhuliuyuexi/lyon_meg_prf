...
standard_parameters = {
    ...
    'num_trials':                       6,        # amount of matcher trials
...
response_button_signs = {
      ...
      #  'y':1,   # right 'more' answer   b
       # 'g':2   # confirm color match y 
        ...
        '1':-1,  # left 'less' answer  e
        '3':1,   # right 'more' answer   b
        '4':2   # confirm color match y 
}      
# response_button_signs = {
#         'b':-1,
#         'y':1
...
full_screen = True
FGC = (0,0,0)
BGC = (255*0.25,255*0.25,255*0.25) # this is converted to -1<->1 in SPSession
...
#DISPSIZE = (1024,768)
DISPSIZE = (1920,1080)#(1920,1080)#(2560,1440)#(1280,720)#,1080)#(1024,768)#(1920,1080)#(2560,1440)
SCREENSIZE = (39,29) #physical screen size in centimeters
SCREENDIST = 76#60.0#65.0#57.0 # centimeters; distance between screen and participant's eyes
#office screen
